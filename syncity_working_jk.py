...
def take_snapshot( lst, auto_segment=False ):
	...
	if auto_segment:
		do_render(lst)
		r = send_data('{} GET Segmentation.Segmentation boundingBoxes'.format(lst[1]))
...
def spawn_drone_objs(destroy=False, ground_limit=204, dist_h=120, dist_v=120, dist_lim=1000, p_x=-20, p_z=-1000, p_y=0):
	...
	spawn_radius_generic(['city/nature/trees'], collision_check=False, limit=random.randint(100,200), radius=80, innerradius=35, position=[0,0,0])
