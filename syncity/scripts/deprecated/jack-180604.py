...
def run():
	...
	if settings.skip_setup == False:
		...
		common.sendData([
			...
			'"Ground" SET RandomProps.FillGrid size (300 300)',
		...
		helpers.spawnDroneObjs(
			...
			treesLimit=[150,200], treesInnerRadius=40, treesRadius=200, buildingsLimit=[100,100], buildingsRadius=200,
			carsLimit=[30,60], carsInnerRadius=6, carsRadius=60,
			#
			# NOTE:
			#
...
#				'"cameras/drone/drone{}/drone{} PUSH RandomProps.RandomColor availableColors "#101010"'.format(x,x),
	...
	common.sendData([
		...
		'"cameras/thermal" SET Camera enabled false',
	...
	while loop < settings.loop_limit:
		...
		common.sendData([
			'"cameras" SET Transform position ({} {}~{} {}) eulerAngles ({}~{} {}~{} {})'.format(0, 15, 55, 0, 45, 90, 0, 180, 0),
