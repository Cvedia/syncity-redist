...
"cameras/cameraRGB" SET Transform localPosition (-8.694 5.835504 10.94819) localEulerAngles (18.773 134.10 0)
"cameras/cameraRGB" ADD Camera AudioListener FlyCamera
"cameras/cameraRGB" SET Camera near 0.3 far 100 fieldOfView 60 renderingPath "UsePlayerSettings" allowHDR true
"cameras/cameraRGB" SET FlyCamera enabled true
...
"cameras/cameraRGB" SET UnityEngine.Rendering.PostProcessing.PostProcessVolume isGlobal false profile "Cold Profile"
"cameras/cameraRGB" EXECUTE UnityEngine.Rendering.PostProcessing.PostProcessLayer Init "PostProcessResources"
...
"cameras/cameraMono" EXECUTE UnityEngine.Rendering.PostProcessing.PostProcessLayer Init "PostProcessResources"
...
"cameras/cameraFishEye" SET Transform localPosition (-2.811435 8.252912 -0.9026188) localEulerAngles (37 140.308 0)
"cameras/cameraFishEye" ADD Camera FlyCamera SphericalCamera
"cameras/cameraFishEye" SET Camera near 0.3 far 100 fieldOfView 60 renderingPath "UsePlayerSettings" allowHDR true
"cameras/cameraFishEye" SET SphericalCamera fisheye true azimuth 180 elevation 120
"cameras/cameraFishEye" SET FlyCamera enabled true
...
"cameras/cameraThermal" SET Transform localPosition (-3.68837 7.814794 -18.25386) localEulerAngles (46.79 58.405 0)
"cameras/cameraThermal" ADD Camera Thermal.ThermalCamera CameraFilterPack_Pixelisation_DeepOilPaintHQ CameraFilterPack_Blur_Noise FlyCamera
...
"cameras/cameraThermal" SET FlyCamera enabled true
...
"cameras/segmentation" SET Transform localPosition (5.692376 5.435938 -3.174489) localEulerAngles (29.945 -17.085 0)
"cameras/segmentation" ADD Camera SegmentationCamera Segmentation.Output.BoundingBoxes Segmentation.Output.ClassColors
"cameras/segmentation" SET SegmentationCamera transparencyCutout 0.5
...
"humans/spawner" SET Humans.Locomotion.WalkerSpawner arriveDistance 0.1 minimumDelayBetweenSpawns 0.5 maximumDelayBetweenSpawns 1.5 minimumSpeed 1.5 maximumSpeed 2.2 maximumHumans 30 container "humans/container"
