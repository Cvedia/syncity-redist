...
[UI.Window] ShowFromCamera "cameras/segmentation" AS "segmentation" WITH 1024 1024 24 "ARGBFloat" "Default"
...
CREATE RenderTexture 1024 1024 24 "ARGB32" "Default" AS "cameraRGB_RT"
...
"cameras/cameraRGB" SET Sensors.RenderCamera format "ARGB32" resolution (1024 1024) alwaysOn false
...
"spawner/city/nature/trees/container" SET RandomProps.PropArea async false numberOfProps 28 collisionCheck false stickToGround false 
...
"spawner/city/buildings/container" SET RandomProps.PropArea async false numberOfProps 49 collisionCheck false stickToGround false 
...
"spawner/animals/birds/container" SET RandomProps.PropArea async false numberOfProps 45 collisionCheck true stickToGround false 
...
"cameras/spawner/drones/container" ADD Segmentation.Class Segmentation.Spawners.Entity
...
"cameras/spawner/drones/container" PUSH RandomProps.SpawnerRandomizers.RandomColor availableColors "#1818C1FF"
