...
CREATE RenderTexture 640 480 24 "ARGB32" "Default" AS "cameraRGB_RT"
...
"cameras/cameraRGB" SET Sensors.RenderCamera format "ARGB32" resolution (640 480) alwaysOn false
...
[UI.Window] ShowFromCamera "cameras/segmentation" AS "segmentation" WITH 640 480 24 "ARGBFloat" "Default"
